...
export class ProductAPIService {
    ...
    async findAll() {
        return await lastValueFrom(this.httpClient.get(this.baseUrlService.getBaseUrl() + 'product/findall2'));
    }
    ...
    async findByCategoryId(id: string) {
        return await lastValueFrom(this.httpClient.get(this.baseUrlService.getBaseUrl() + 'product/findByCategory/' + id));
    }
